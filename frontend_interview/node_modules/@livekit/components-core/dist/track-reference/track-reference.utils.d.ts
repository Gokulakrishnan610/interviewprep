...
import type { PinState } from '@livekit/components-core/src/types';
import type { TrackReferenceOrPlaceholder } from '@livekit/components-core/src/track-reference/track-reference.types';
/**
